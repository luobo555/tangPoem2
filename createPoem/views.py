...
'''
poetry_file = 'static/data/data.txt'
model_file = 'static/model/poetry.module-99'
...
def geneHeadPoetry(heads, type):
    ...
    return gen_head_poetry(heads, type)
...
def createPoem(request):
    ...
    if select == '1':
        ...
        result = geneHeadPoetry(heads, int(type))
        tf.reset_default_graph()
    else:
        result = '555'
